...
export interface ApiLandingPageLandingPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    featurePageIntro: Attribute.JSON;
    hero: Attribute.JSON;
    pricingPageIntro: Attribute.JSON;
    publishedAt: Attribute.DateTime;
...
export interface ApiStatsDashboardStatsDashboard extends Schema.SingleType {
  collectionName: 'stats_dashboards';
  info: {
    displayName: 'Stats Dashboard';
    pluralName: 'stats-dashboards';
    singularName: 'stats-dashboard';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    accessibilityIssuesFound: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<0>;
    averageComplianceScore: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    > &
      Attribute.Private;
    publishedAt: Attribute.DateTime;
    totalSitesCrawled: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<0>;
    trend: Attribute.JSON & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::stats-dashboard.stats-dashboard',
      'oneToOne',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::stats-dashboard.stats-dashboard': ApiStatsDashboardStatsDashboard;
